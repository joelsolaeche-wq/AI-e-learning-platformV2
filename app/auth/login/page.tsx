  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        {state?.error && (
          <div role="alert" className="flex items-start gap-2.5 rounded-xl border border-rose-400/40 bg-rose-400/10 px-3.5 py-3 text-[13px] text-rose-300">
        ...
        <form action={formAction} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="group relative">
              <Mail size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary" />
              <input
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="group relative">
              <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary" />
              <input
